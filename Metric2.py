...
class Metric(object):
    ...
    def __init__(self, vertices, edges):
        print(dir(vertices))
        print(dir(vertices["id"]))
        print(vertices.select("id"))
        print(vertices.foreach(self.stupid))
        print(vertices.agg({"id":"sum"}).collect())
    ...
    def overall_clustering_coefficient(self):
        ...
        num_triangles_frame.withColumn("2t", num_triangles_frame.name*2)
